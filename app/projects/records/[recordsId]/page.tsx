      ...
      if (session?.user?.accessToken || recordsId) {
        try {
          ...
          const achievementsUrl = recordsId
            ? `http://127.0.0.1:8000/usuario/achievement/list_user_achievements_id/`
            : 'http://127.0.0.1:8000/usuario/achievement/list_user_achievements/'

          const metricsUrl = recordsId
            ? `http://127.0.0.1:8000/usuario/achievement/metrics_id/`
            : 'http://127.0.0.1:8000/usuario/achievement/metrics/'
